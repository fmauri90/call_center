...
class Technician(Base):
    ...
    def __init__(self, id_company, data_technician, chat_id, status, message):
        """"""
...
class Call(Base):
    ...
    id_technician = Column(Integer)

    def __init__(self, id_condominium, id_company, date_call,  data_call, call_status, id_technician):
        """"""
